...
namespace XPlatformCloudKit
{
    ...
    public static class AppSettings
    {
        ...
        public static List<UrlSource> RssAddressCollection = new List<UrlSource>()
        {
        ...
        //public const string YoutubeClientSecret = "";

        //Created @ https://code.google.com/apis/console, enable YouTube Data API v3 under APIs then click Credentials
        //Under Public API Access - click "Create New Key"
        public const string YoutubePublicAPIKey = "";

        public static List<UrlSource> YoutubeAddressCollection = new List<UrlSource>()
        {
        ...
        public static List<UrlSource> TwitterAddressCollection = new List<UrlSource>()
        {
        ...
        public const bool EnableRemoteUrlSourceService = false;
        /*
        ...
        //public const string RemoteUrlSourceUrl = "http://pjdecarlo.com/playground/remoteUrlSourceExample.html";
        public const string RemoteUrlSourceUrl = "";
        #endregion
    }
}
